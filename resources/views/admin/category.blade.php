    ...
    <div class="page-content">
      <div class="page-header">
        <div class="container-fluid">
          <h1 style="color: cadetblue">اضافة نوع طعام</h1>
          <br>
          ...
          <table style="width: 100%" class="table_deg">
            ...
            <tr>
              <form action="{{ route('category.edit', ['id' => $service->id]) }}" method="post" enctype="multipart/form-data">
                @csrf
                <td>
              ...
              <td>
                <form action="{{ route('category.delete', ['id' => $service->id]) }}" method="post" enctype="multipart/form-data">
                  @csrf
